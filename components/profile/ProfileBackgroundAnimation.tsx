...
export const ProfileBackgroundAnimation = () => {
  ...
  useEffect(() => {
    ...
    const vibrantColors = [
      "rgba(91, 79, 232, 0.2)", // Primary indigo
      "rgba(91, 79, 232, 0.15)", // Primary indigo, softer
      "rgba(107, 107, 107, 0.15)", // Neutral
      "rgba(91, 79, 232, 0.1)", // Primary indigo, faint
      "rgba(107, 107, 107, 0.1)", // Neutral, faint
      "rgba(91, 79, 232, 0.25)", // Primary indigo, stronger
    ];
  ...
  return (
    <div className="absolute inset-0 pointer-events-none overflow-hidden">
      ...
      <motion.div
        className="absolute w-[400px] h-[400px] rounded-full opacity-20 bg-gradient-to-r from-primary/40 to-primary/10"
      ...
      <motion.div
        className="absolute w-[500px] h-[500px] rounded-full opacity-10 bg-gradient-to-r from-muted-foreground/30 to-primary/30"
